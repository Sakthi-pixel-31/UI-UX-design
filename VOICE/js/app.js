...
const SETTINGS_CONTENT = {
  profile: `
    <div class="settings-section">
      ...
      <div style="display:flex;align-items:center;gap:16px;margin-bottom:20px;">
        <div style="width:60px;height:60px;border-radius:16px;background:linear-gradient(135deg,#18A9E5,#F4C542);display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:700;color:white;flex-shrink:0">S</div>
        <div>
          <div style="font-size:14px;font-weight:700;color:var(--text-primary)">Sakthivel</div>
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <input class="form-input" value="Sakthivel" />
        </div>
        <div class="form-group">
          <label class="form-label">Last Name</label>
          <input class="form-input" value="M" />
        </div>
      </div>
      <div class="form-group">
        <label class="form-label">Email Address</label>
        <input class="form-input" value="sakthivoice.in" />
      </div>
      <div class="form-group">
        <label class="form-label">Phone Number</label>
        <input class="form-input" value="+91 9087774556" />
      </div>
  ...
  team: `
    <div class="settings-section">
      ...
      ${[
        { name: 'Sakthivel M', role: 'Admin', email: 'sakthivoice.in', initials: 'SM' },
